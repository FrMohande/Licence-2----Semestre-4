...
import battleship.direction.EastDirection;
import battleship.direction.NorthDirection;
...
public class Game {
	...
	private void displayInstructions() {
		System.out.println("Enter the coordinates of targetted cell (x,y) using the form: x y, by example : 3 2");
